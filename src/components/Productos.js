...
const Index = () => {
    ...
    const getProducts = async () => {
        const response = await fetch("https://recycledj.com/wp-json/wc/v3/products/?per_page=50&consumer_key=ck_00b2f37c17aa393706939ecb185e4c88d0c16773&consumer_secret=cs_f7c56d656d32ebcd3cf787492189eae8f44a3f91");
                        ...
                        return (
                            ...
                            <div className="card_item" key={curElem.id}>
                                <div className="card_inner">
                                    <img src={curElem.images[0].src} alt="" />
